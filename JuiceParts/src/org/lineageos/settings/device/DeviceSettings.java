...
Preference.OnPreferenceChangeListener {
    ...
    public static final String VIBRATION_STRENGTH_PATH = "/sys/class/leds/vibrator/vmax_nv";
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        if (FileUtils.fileWritable(DOUBLE_TAP_TO_WAKE_PATH)) {
            ...
            double_tap_to_wake.setChecked(FileUtils.getFileValueAsBoolean(DOUBLE_TAP_TO_WAKE_PATH, isDT2W));
        ...
        mClearSpeakerPref.setOnPreferenceClickListener(> {
